...
### POISED dataset
The detailed step-by-step guide to process POISED dataset is available [here](https://github.com/abbioinfo/runPOISED). Briefly, the following set of codes allows you to execute CyAnno on POISED dataset and compute F1 score of each sample and cell type, as published in the orignal article.
