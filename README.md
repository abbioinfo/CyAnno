...
# Installation
CyAnno does not require any installation and can be executed with command line interface. However, python (3.0 or above) is required with numpy, pandas, skit-learn, skipy, xgboost, pickle, fcsparser and itertools libraries. For convinience, we recommend anaconda for python and library installation.
