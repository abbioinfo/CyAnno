...
loadModel = False		## When you are using previously generated model you need to change this to 'True' and in the 'outdir' parameter set the path of the CyAnno generated output folder, having all the session files and models.
